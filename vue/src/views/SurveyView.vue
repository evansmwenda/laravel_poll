<template>
    <PageComponent>
      <template v-slot:header>
        <div class="flex items-center justify-between">
          ...
          <div class="flex">
            <TButton v-if="model.slug" link :href="`/view/poll/${model.slug}`" target="_blank" class="mr-2">
  ...
  const surveyLoading = computed(() => store.state.currentPoll.loading);
  ...
  function deleteSurvey() {
    if (
      confirm(
        ...
        console.log("deleing pollids ->"+model.value.id);
